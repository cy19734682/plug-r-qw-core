 ...
 * @returns {function(...[*]=)}
 */
export declare function tooltipManual(contentKey: string | string[] | ((params: any) => string), dash?: boolean, jointMark?: string): (_h: any, params: any) => globalThis.VNode<import("vue").RendererNode, import("vue").RendererElement, {
    [key: string]: any;
}>;
