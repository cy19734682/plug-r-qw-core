...
export default function (this: any, option: string | {
  title?: string, content?: string, text?: string, type?: string, icon?: string, onOk?: () => void
  className?: string, buttons?: ButtonS | Array<string>
} | boolean, text?: string | HTMLElement, icon?: string) {
