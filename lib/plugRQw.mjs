...
function s(e, n, t) {
  t = t || {}, t.arrayMerge = t.arrayMerge || F, t.isMergeableObject = t.isMergeableObject || S;
...
const C = function(e, n) {
  ...
  dev: "vite",
  build: "run-p type-check build-only && gulp",
  ...
  devDependencies: ie,
  engines: ce
}, g = /* @__PURE__ */ Object.assign({ "./components/Hello.vue": E });
let m = {};
for (const e in g)
