...
}, yn = { class: "pageContainer" }, vn = 300, Il = /* @__PURE__ */ re({
  __name: "BtTablePage",
  props: {
    url: { default: "" },
    searchData: { default: () => ({}) },
...
}), zn = /* @__PURE__ */ M("div", { class: "bRoot" }, null, -1), St = /* @__PURE__ */ re({
  __name: "MonthRange",
  props: {
    modelValue: { default: () => ["", ""] },
...
}), Hn = { class: "editor-pro-root" }, Lt = /* @__PURE__ */ re({
  __name: "EditorPro",
  props: {
...
}), qn = /* @__PURE__ */ M("input", { type: "text" }, null, -1), Jn = { class: "inlineBlock" }, gl = /* @__PURE__ */ re({
  __name: "FormR",
  props: {
    formData: { default: () => [] },
    formRules: { default: () => ({}) },
...
const at = {
  ...
  Re.init(o.useStore || o.store, a), a.use(da), o.locale && ml.use(o.locale), o.i18n && ml.i18n(o.i18n), o.router && tn(o.router), o.amap && wn(o.amap), o.notRegistryGlobal || (Object.keys(tt).forEach((e) => {
