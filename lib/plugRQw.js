...
}), Fa = { class: "c404K" }, Ra = /* @__PURE__ */ P("div", { class: "t404" }, "404", -1), Ka = { class: "ct404" }, Ma = { class: "p404" }, za = /* @__PURE__ */ pe({
  __name: "Page404",
  setup(t) {
    ...
    return (a, o) => {
      ...
      return x(), N("div", Fa, [
        Ra,
        P("div", Ka, "UH OH! " + H(f(L)("r.pageNotFound")), 1),
        P("div", Ma, H(f(L)("r.notFoundMsg")), 1),
        q(s, {
          class: "bt404",
          onClick: e
        }, {
...
}), rn = { class: "contentX" }, un = { class: "arrowA" }, Mt = /* @__PURE__ */ pe({
            ...
            if ((F == null ? void 0 : F.name) === void 0)
              if (F.id) {
                ...
                Y ? (F.name = Y.name, F.mimeType = Y.mimeType) : d.hasOwnProperty(F.id) ? (F.name = d[F.id].name, F.mimeType = d[F.id].mimeType) : (F.mimeType = "loading", Ne.get(e.url + "/" + F.id).then((Q) => {
                  ...
                  F.name = ((me = (ve = (de = Q == null ? void 0 : Q.data) == null ? void 0 : de.returnValue) == null ? void 0 : ve[0]) == null ? void 0 : me.name) || L("r.file") + il(v, F), F.mimeType = ((U = (ne = (Le = Q == null ? void 0 : Q.data) == null ? void 0 : Le.returnValue) == null ? void 0 : ne[0]) == null ? void 0 : U.mimeType) || "unknown", oa(o);
                }).catch(() => {
