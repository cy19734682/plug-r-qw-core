...
const en = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  decimalDigitsLimit: Wa,
  downloadFileByFormSubmit: Ol,
  fileExport: ja,
  findCollection: et,
  formDataHeadConfig: Ea,
  getColumnsKeys: qa,
  has: Na,
  hasPermission: Jt,
  htmlPrint: Za,
  ...
  tooltipManual: Al,
  trimObj: _t
}, Symbol.toStringTag, { value: "Module" })), tn = { class: "groupBoxRP" }, ln = ["onClick"], an = /* @__PURE__ */ pe({
...
}), nn = { class: "menuListR" }, on = /* @__PURE__ */ pe({
  __name: "SideMenu",
  props: {
    data: { default: () => [] }
  },
...
}), rn = { class: "contentX" }, un = { class: "arrowA" }, Kt = /* @__PURE__ */ pe({
...
}), dn = { class: "contentZ" }, cn = /* @__PURE__ */ pe({
...
const yn = { class: "tabSetF" }, vn = { class: "cannotSelect" }, gn = { class: "topCheck" }, bn = /* @__PURE__ */ P("span", { class: "iconfont icon-r-save" }, null, -1), Rl = /* @__PURE__ */ pe({
  __name: "TableSetting",
  props: {
    modelValue: { default: () => [] },
    sKey: {},
...
const Ne = {
  ...
  setup(t, { expose: i, emit: n }) {
    ...
    const C = E(() => {
      ...
      return o.sortable === "custom" && (o.orderKeyFormat === "underline" ? U[v] = Ll(k) : o.orderKeyFormat === "camelcase" && (U[v] = kn(k))), U;
    }), B = E(() => {
...
const Ul = /* @__PURE__ */ pe({
  ...
  setup(t, { emit: i }) {
    ...
    return De(g), Cl(() => {
      var S;
      v && (v.destroy(), (S = rl) == null || S.reset(), v = null, C = null, c = null);
    }), (S, R) => (x(), N("div", {
      style: re(f(d)),
      class: "containerIKJ"
    }, [
...
function dt(t, i = 0) {
  ...
  function C(_) {
    _.keyCode === 37 || _.keyCode === 38 || _.keyCode === 87 || _.keyCode === 65 ? yl(m, t, k, v) : _.keyCode === 39 || _.keyCode === 40 || _.keyCode === 83 || _.keyCode === 68 ? vl(m, t, k, v) : _.keyCode === 27 && g();
  }
  document.addEventListener("keyup", C), (I = p == null ? void 0 : p.appendChild) == null || I.call(p, c), c.focus({ preventScroll: !0 });
}
const Kn = { class: "previewBoxM" }, zn = { class: "imgLoading" }, Dn = /* @__PURE__ */ P("div", {
...
const Hl = /* @__PURE__ */ pe({
  ...
  setup(t, { emit: i }) {
            ...
            if ((F == null ? void 0 : F.name) === void 0)
              if (F.id) {
                ...
                Y ? (F.name = Y.name, F.mimeType = Y.mimeType) : d.hasOwnProperty(F.id) ? (F.name = d[F.id].name, F.mimeType = d[F.id].mimeType) : (F.mimeType = "loading", Ne.get(e.url + "/" + F.id).then((Q) => {
                  ...
                  F.name = ((me = (ve = (de = Q == null ? void 0 : Q.data) == null ? void 0 : de.returnValue) == null ? void 0 : ve[0]) == null ? void 0 : me.name) || L("r.file") + il(y, F), F.mimeType = ((U = (ne = (Le = Q == null ? void 0 : Q.data) == null ? void 0 : Le.returnValue) == null ? void 0 : ne[0]) == null ? void 0 : U.mimeType) || "unknown", oa(o);
                }).catch(() => {
                  F.name = L("r.file") + il(K, F);
                }));
              } else
                F.name = L("r.unknown");
          o.value = K;
    ...
    function A(y) {
      j(y) === "String" && y.indexOf("http") > -1 ? window.open(y) : j(y) === "File" && cl(y).then((K) => {
        wn(y.name, K);
      });
    }
    function I(y) {
...
}), oo = /* @__PURE__ */ P("div", { class: "bRoot" }, null, -1), Wl = /* @__PURE__ */ pe({
  __name: "MonthRange",
  props: {
    modelValue: { default: () => ["", ""] },
...
}), io = { class: "editor-pro-root" }, jl = /* @__PURE__ */ pe({
  __name: "EditorPro",
  props: {
  ...
  setup(t, { expose: i, emit: n }) {
    ...
    let p = [], c = [];
    const g = G(!1), k = G(Math.random() * 1e8 + 1e3), v = (nl = window == null ? void 0 : window.g) != null && nl.mgrURL ? window.g.mgrURL + "/web/v1/fsc/file" : "/file";
    let C = !1;
...
}), Fo = { class: "boxLPB" }, Ro = { class: "headerF" }, Mo = { class: "firstT borderBoxKa" }, Ko = { class: "secondT borderBoxKa" }, zo = { class: "thirdT borderBoxKa" }, Do = { class: "firstCol borderBoxKa" }, Uo = { class: "rightBoxAL" }, No = { class: "secondCol borderBoxKa" }, Eo = { class: "thirdCol borderBoxKa" }, Go = /* @__PURE__ */ pe({
  ...
  setup(t, { emit: i }) {
    ...
    return (m, p) => {
      ...
      return x(), N("div", Fo, [
        P("div", Ro, [
          P("div", Mo, H(m.firstTitle || f(L)("r.level.1")), 1),
          P("div", Ko, H(m.secondTitle || f(L)("r.level.2")), 1),
...
const zi = wt.use, Di = wt.i18n, wl = {
  ...
  Ne.init(i.useStore || i.store, t), t.use(_a), i.locale && wt.use(i.locale), i.i18n && wt.i18n(i.i18n), i.router && (fn(i.router), Yt.init(i.router)), i.amap && Rn(i.amap), i.notRegistryGlobal || (Object.keys(bl).forEach((n) => {
