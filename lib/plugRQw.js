...
import { getCurrentInstance as hl, defineComponent as se, resolveComponent as j, openBlock as x, createElementBlock as D, normalizeClass as Ae, normalizeStyle as Q, createBlock as J, createCommentVNode as he, renderSlot as Ie, ref as z, computed as P, withDirectives as xe, unref as h, createElementVNode as U, toDisplayString as H, createVNode as N, withCtx as G, createTextVNode as pe, vShow as Le, resolveDirective as at, h as be, Fragment as me, renderList as ve, onBeforeMount as Nt, watch as ke, nextTick as Re, isRef as Fe, onMounted as Xe, withModifiers as Et, mergeProps as al, onUnmounted as Gt, shallowRef as wl, onBeforeUnmount as zt, createSlots as Ye } from "vue";
import Ht from "deepmerge";
import { isObject as Wt, isFunction as jt, isPlainObject as qe, cloneDeep as ie, isEmpty as Ce, isBoolean as qt, isNumber as Je, debounce as Jt, isString as nt, last as dl, isEqual as ll, first as Vl, indexOf as Hl, findIndex as ot, remove as Yt, find as Wl } from "lodash-es";
import ol from "sweetalert";
import { Tooltip as Xt, TableColumnConfig as Zt, Radio as Qt, Input as ea, Modal as Ne, Icon as la, Button as kl } from "view-ui-plus";
import { useRouter as ta, useRoute as aa } from "vue-router";
import { useI18n as na } from "vue-i18n";
import _l from "axios";
...
function da() {
  ...
  function o(e, ...t) {
    let u;
    return t.length === 1 && typeof t[0] == "object" && (u = t[0]), (!u || !u.hasOwnProperty) && (u = {}), e === void 0 ? "" : e.replace(ua, (n, c, s, p) => {
      let r;
...
let jl, ql = {}, Be, pa = function(a, o) {
  if (typeof this == "object" && Reflect.has(this, "$t"))
    return this.$t(a, o);
  if (Be && Be.global)
    return Be.global.t(a, o);
  if (Be && Be.locale) {
    if (!ql[Be.locale] || jl != Be.locale) {
      ql[Be.locale] = !0;
      let e = Be.getLocaleMessage(Be.locale) || {}, t = Ht(fa[Be.locale], e, { clone: !0 });
      cl = t, Be.setLocaleMessage(Be.locale, t), jl = Be.locale;
    }
    return Be.hlang(a, o);
  }
};
const $e = function(a, o) {
  let e = pa.apply(this, [a, o]);
  if (e != null)
    return e;
  const t = a.split(".");
  let u = cl;
...
}), ya = { class: "headerTxtAM" }, va = { class: "contentAM" }, ga = /* @__PURE__ */ se({
  __name: "FullPop",
  props: {
    title: {},
    headerColor: {},
  ...
  setup(a, { expose: o, emit: e }) {
    ...
    return o({
      ...
      U("div", {
        ...
        U("span", ya, H(r.title || h(S)("r.title")), 1),
        N(st, {
          icon: "md-return-left",
          onClick: p
        }, {
...
}), ba = { class: "msg" }, ka = /* @__PURE__ */ se({
  __name: "Hello",
  setup(a) {
    let o = z("Greetings from Ricky.");
    return (e, t) => (x(), D("span", ba, H(h(o)), 1));
  }
});
function yl() {
...
}), Va = { class: "c404K" }, _a = /* @__PURE__ */ U("div", { class: "t404" }, "404", -1), Ca = { class: "ct404" }, Aa = { class: "p404" }, Ba = /* @__PURE__ */ se({
  __name: "Page404",
  setup(a) {
    ...
    return (u, n) => {
      ...
      return x(), D("div", Va, [
        _a,
        U("div", Ca, "UH OH! " + H(h(S)("r.pageNotFound")), 1),
        U("div", Aa, H(h(S)("r.notFoundMsg")), 1),
        N(c, {
          class: "bt404",
          onClick: t
        }, {
...
const La = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  findPath: pl,
  getFileSrc: rl,
  getFileTypeByName: Ml,
  getFileTypeIconByName: Cl,
  getStringWidth: ct,
  htmlDecode: Ta,
  htmlEncode: xa,
  isImgByFile: ul,
...
function Na(a, o = !1, e = !1) {
  ...
  for (let n in t)
    if (t.hasOwnProperty(n)) {
      let c = t[n];
      c === void 0 || c === "" || K(c) === "String" && c.trim() === "" || c === null || yt(c) ? e ? o ? u += n + "=&" : t[n] = "" : delete t[n] : o && (u += n + "=" + c + "&");
    }
...
function Bl(a) {
  ...
  if (Array.isArray(a)) {
    o = [];
    for (let e of a)
      Array.isArray(e) || qe(e) ? o.push(Bl(e)) : we(e) && o.push(e);
  } else if (qe(a))
    for (let e in a)
      a.hasOwnProperty(e) && (Array.isArray(a[e]) || qe(a[e]) ? o[e] = Bl(a[e]) : we(a[e]) && (o[e] = a[e]));
  return o;
}
function Ea(a) {
  const o = window.open();
...
const gt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  tooltipManual: mt,
  trimObj: ml
}, Symbol.toStringTag, { value: "Module" })), Ga = { class: "groupBoxRP" }, za = ["onClick"], Ha = /* @__PURE__ */ se({
...
}), Wa = { class: "menuListR" }, ja = /* @__PURE__ */ se({
  __name: "SideMenu",
  props: {
    data: { default: () => [] }
  },
  emits: ["on-change"],
  setup(a, { emit: o }) {
    const e = a, t = aa(), u = z(!0), n = z(), c = z(), s = P(() => u.value ? S("r.hideMenu") : S("r.showMenu")), p = P(() => u.value ? "ios-arrow-back" : "ios-arrow-forward");
    Nt(() => {
...
}), Ya = { class: "contentX" }, Xa = { class: "arrowA" }, xl = /* @__PURE__ */ se({
...
}), Za = { class: "contentZ" }, Qa = /* @__PURE__ */ se({
...
}), tn = { class: "tabSetF" }, an = { class: "topCheck" }, nn = /* @__PURE__ */ se({
  __name: "TableSetting",
  props: {
    modelValue: { default: () => [] },
    sKey: {},
...
function kt(a) {
  let o = ze;
  a ? ze++ : ze > 0 && ze--, o !== ze && (ze === 0 ? Jl(!1) : o === 0 && Jl(!0));
}
const on = window.location.origin;
let je = null;
const Yl = (...a) => $e.apply(je, a);
let Oe = _l.create({
  baseURL: on,
  withCredentials: !0
  // 允许携带cookie
...
const Ke = {
  ...
  ref: "tableBox"
}, dn = { class: "topBtn" }, cn = { class: "fullHeight relativeBox" }, fn = {
  ref: "tableContainerLOI",
  class: "fullFlowContent"
}, pn = { class: "pageContainer" }, mn = 300, Il = /* @__PURE__ */ se({
  __name: "BtTablePage",
  props: {
    url: { default: "" },
    searchData: { default: () => ({}) },
  ...
  setup(a, { expose: o, emit: e }) {
    ...
    const V = P(() => {
      ...
      return t.sortable === "custom" && (t.orderKeyFormat === "underline" ? R[y] = ft(v) : t.orderKeyFormat === "camelcase" && (R[y] = rt(v))), R;
    }), C = P(() => {
      ...
      return R.forEach((F) => {
        ...
        F.key && F.render === void 0 && (F.tooltip ? F.render = mt(F.key, !0) : F.render = (fe, ue) => {
          let Ve = ue.row[F.key];
    ...
    function E(R, F, fe) {
      let ue = null;
      if (qt(F) && F ? ue = b : Je(F) && (ue = F), ue !== null) {
        let Ve = s.value[ue];
        for (let Z in R)
...
var vn = Vt.exports;
const sl = /* @__PURE__ */ yn(vn);
let Ll = { securityJsCode: "", key: "" };
function gn({ securityJsCode: a, key: o }) {
  Ll.securityJsCode = a, Ll.key = o;
}
function bn(a) {
  return Ll[a];
}
const _t = /* @__PURE__ */ se({
  ...
  setup(a, { emit: o }) {
    ...
    return Xe(_), Gt(() => {
      v && (v.destroy(), sl == null || sl.reset(), v = null, y = null, f = null);
    }), (C, B) => (x(), D("div", {
      style: Q(h(c)),
      class: "containerIKJ"
    }, [
...
const Ct = /* @__PURE__ */ se({
  ...
  setup(a, { emit: o }) {
    const e = a, t = z([]), u = P({
      get() {
        let r = e.modelValue;
        return Array.isArray(r) ? ie(r) : Je(r) ? pl({
          group: t.value,
      ...
      set(r) {
        if (e.onlyLastVal)
          Ce(r) ? (o("update:modelValue", null), o("on-label-change", null)) : o("update:modelValue", dl(r));
        else {
  ...
  setup(a, { emit: o }) {
    const e = a, t = z(), u = P({
      get() {
        if (e.modelValue && (Je(e.modelValue) || nt(e.modelValue))) {
    ...
    return (c, s) => (x(), J(h(oa), al(c.$attrs, {
      class: "alCascaderMC",
      ref_key: "alCRef",
      ref: t,
      modelValue: h(u),
...
const Bt = /* @__PURE__ */ se({
  ...
  setup(a, { emit: o }) {
    const e = a, t = wl([]), u = wl([]), n = P(() => !e.manualUpload && e.showImg && r.value ? "img" : e.manualUpload && e.showImg && r.value ? "localImg" : e.manualUpload && e.showUploadList && (!e.showImg || !r.value) ? "localList" : !e.manualUpload && e.showUploadList && (!e.showImg || !r.value) ? "list" : ""), c = P(() => e.manualUpload ? "//jsonplaceholder.typicode.com/posts/" : e.url), s = P({
      ...
      for (let O of g) {
        let E;
        if (e.manualUpload ? E = O && O.type : E = O && O.mimeType, !E || E && !ul(E))
          return !1;
      }
      return !0;
    });
            ...
            if (oe.name === void 0)
              if ((ee = (E = (O = oe.response) == null ? void 0 : O.data) == null ? void 0 : E[0]) != null && ee.id) {
                let de = await Ke.get(e.url + "/" + oe.response.data[0].id).catch(() => {
                  ne.push({ name: S("r.file") + Hl(g, oe) });
                }), re = ie(oe);
                re.name = ((ce = (q = (ae = de == null ? void 0 : de.data) == null ? void 0 : ae.returnValue) == null ? void 0 : q[0]) == null ? void 0 : ce.name) || S("r.file") + Hl(g, oe), re.mimeType = ((ge = (W = (ye = de == null ? void 0 : de.data) == null ? void 0 : ye.returnValue) == null ? void 0 : W[0]) == null ? void 0 : ge.mimeType) || "unknown", ne.push(re);
              } else
    ...
    function d(g) {
      return g.name || g.split && dl(g.split("/")) || g;
    }
    async function f(g) {
      let O = [];
      for (let E of g) {
    ...
    function v(g) {
      var O, E, ee;
      return e.manualUpload ? g.type && ul(g.type) : ((ee = (E = (O = g == null ? void 0 : g.response) == null ? void 0 : O.data) == null ? void 0 : E[0]) == null ? void 0 : ee.id) && g.mimeType && ul(g.mimeType);
    }
    function y(g) {
      e.manualUpload ? rl(g).then((O) => {
        Ee(O);
      }) : Ee(e.url + "/" + g.response.data[0].id + "/download?preview=true");
    }
    function V(g) {
      K(g) === "String" && g.indexOf("http") > -1 ? window.open(g) : K(g) === "File" && rl(g).then((O) => {
        ut(g.name, O);
      });
    }
    function T(g) {
...
}), Pn = /* @__PURE__ */ U("div", { class: "bRoot" }, null, -1), xt = /* @__PURE__ */ se({
  __name: "MonthRange",
  props: {
    modelValue: { default: () => ["", ""] },
...
}), Rn = { class: "editor-pro-root" }, Tt = /* @__PURE__ */ se({
  __name: "EditorPro",
  props: {
      ...
      return x(), J(M, {
        ...
        default: G(() => [
          e.item.type === "txt" ? (x(), D("div", {
            ...
            _: 1
          }, 8, ["modelValue", "style", "filterable", "disabled", "multiple", "placeholder", "clearable"])) : e.item.type === "selectInput" ? (x(), J(wt, {
            key: 4,
            modelValue: r.tempKeys[e.item.tempKey],
            ...
            disabled: !!e.item.disabled || e.disabled,
            onOnChange: c
          }, null, 8, ["modelValue", "label-width", "item-width", "select-option", "placeholder", "clearable", "disabled"])) : e.item.type === "alCascader" ? (x(), J(At, {
            key: 5,
            style: Q(r.itemStyle),
            class: "inlineBlock",
          ...
          }, null, 8, ["style", "modelValue", "level", "disabled", "filterable", "placeholder", "change-on-select"])) : e.item.type === "asyncCascader" ? (x(), J(Ct, {
            key: 6,
            style: Q(r.itemStyle),
            modelValue: e.valGroup[e.item.key],
            ...
            clearable: e.item.clearable !== !1
          }, null, 8, ["modelValue", "autosize", "style", "maxlength", "show-word-limit", "placeholder", "disabled", "clearable"])) : e.item.type === "upload" ? (x(), J(Bt, {
            key: 12,
            style: Q(r.itemStyle),
            class: "inlineBlock",
            modelValue: e.valGroup[e.item.key],
          ...
          }, null, 8, ["style", "modelValue", "type", "disabled", "placeholder", "steps", "clearable", "format"])) : e.item.type === "monthRange" ? (x(), J(xt, {
            key: 15,
            style: Q(r.itemStyle),
            modelValue: r.tempKeys[e.item.tempKey],
          ...
          }, null, 8, ["style", "modelValue", "disabled", "placeholder", "options1", "options2"])) : e.item.type === "editorPro" ? (x(), J(Tt, {
            key: 16,
            class: "inlineBlock",
            style: Q(r.itemStyle),
            modelValue: e.valGroup[e.item.key],
          ...
          }, null, 8, ["style", "modelValue", "placeholder", "disabled", "toolbar-config", "editor-config", "mode", "height"])) : e.item.type === "inputMap" ? (x(), J(_t, {
            key: 17,
            modelValue: r.tempKeys[e.item.tempKey],
...
}), Dn = /* @__PURE__ */ U("input", { type: "text" }, null, -1), Nn = { class: "inlineBlock" }, vl = /* @__PURE__ */ se({
  __name: "FormR",
  props: {
    formData: { default: () => [] },
    formRules: { default: () => ({}) },
  ...
  setup(a, { expose: o, emit: e }) {
    ...
    let p = [];
    const r = ((Gl = window == null ? void 0 : window.g) == null ? void 0 : Gl.mgrURL) ?? "";
    let d = [], f = [];
    const _ = z(!1), b = z(Math.random() * 1e8 + 1e3), v = (zl = window == null ? void 0 : window.g) != null && zl.mgrURL ? window.g.mgrURL + "/web/v1/fsc/file" : "/file";
    let y = !1;
    ...
    function $l(i) {
      i.beforeKey && Yt(d, (l) => l === i.beforeKey), i.key && (d.indexOf(i.key) === -1 && d.push(i.key), Ge({
        e: null,
        root: i
      }));
    }
    function Dl({ name: i, root: l }) {
      l.key2 && (n.value[l.key2] = i), Ge({
        e: i,
        root: l
      });
    }
    function Nl({ e: i, root: l }) {
      Ge({
        e: i,
        root: l
      }), Re(function() {
    ...
    function gl() {
      ...
      t.disabled || (l = (i = u.value) == null ? void 0 : i.validate) == null || l.call(i, (A) => {
        y || (y = !0, A && (_.value = !0, e("on-submit", El())), Te(() => {
          y = !1;
        }, 2e3));
      });
    }
          ...
          h(V) ? (x(!0), D(me, { key: 0 }, ve(h(c), (le, X) => (x(), D("div", {
            ...
            (x(!0), D(me, null, ve(le, ($, Y) => (x(), D(me, {
              ...
              W($) ? (x(), J(Zl, {
                ...
                onSelectInputChange: $l,
                onAlNameChange: Dl,
                onAsyncLabelChange: Kl
              }, Ye({ _: 2 }, [
                ve(M(le), (_e) => ({
                  name: _e.slotName,
                  fn: G((Ue) => [
  ...
  setup(a, { emit: o }) {
    ...
    function r(v, y = []) {
      for (let V of v) {
        let T = !1;
        s.value.length > 1 ? T = Wl(p.value, (C) => C[s.value[0]] === V[s.value[0]]) !== void 0 : T = s.value[0] ? p.value.indexOf(V[s.value[0]]) !== -1 : !1;
        let w = {
          name: V[e.label],
...
const et = {
  ...
  Ke.init(o.useStore || o.store, a), o.locale && fl.use(o.locale), o.i18n && fl.i18n(o.i18n), o.router && en(o.router), o.amap && gn(o.amap), o.notRegistryGlobal || (Object.keys(Ql).forEach((e) => {
